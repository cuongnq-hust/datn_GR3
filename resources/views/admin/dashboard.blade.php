...
<div class="container-fluid">
    ...
    <div class="row">
        <p class="title_thongke">Thống kê doanh thu shop</p>
    ...
    <div class="row">
            ...
            <ol class="list_views">
                ...
                <li>
                    <a target="_blank" href="{{url('/bai-viet/'.$post->post_slug)}}">
                        {{$post->post_title}} | <span style="color: black">
                            {{$post->post_views}}
                        </span>
                    </a>
                </li>
        ...
        <div class="col-md-4 col-xs-12">
            ...
            <ol class="list_views">
                ...
                <li>
                    <a target="_blank" href="{{url('/chi-tiet-san-pham/'.$product->product_slug)}}">
                        {{$product->product_name}} | <span style="color: black">
