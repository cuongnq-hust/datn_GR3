            ...
            <table class="table table-striped b-t b-light">
                ...
                <tbody>
                    ...
                    <tr class="color_qty_{{$details->product_id}}">
                        ...
                        <td>
                            <input type="number" disabled min="1" style="width: 60px;" class="order_qty_{{$details->product_id}}" value="{{$details->product_sales_quantity}}" name="product_sales_quantity">
                        </td>
